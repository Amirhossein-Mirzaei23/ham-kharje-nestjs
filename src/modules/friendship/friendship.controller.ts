import { Controller, Post, Body, Param, Delete, Get, Patch, UseGuards, Query } from '@nestjs/common';
import { FriendshipService } from './friendship.service';
import { CreateFriendDto } from './dto/create-friend.dto'; 
import { AcceptFriendRequestDto, SendFriendRequestDto, UpdateFriendDto } from './dto/update-friend.dto'; 
